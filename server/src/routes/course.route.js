...
import { createCourseController, deleteCourseByIdController, getAllCourseController, getCourseByCategory, getCourseByEnrolledId, getCourseByIdController, getCourseBySearch, getCourseController, updateCourseController } from '../controllers/course.controller.js'
...
courseRouter.get('/getByEnrolledId', authMiddleware, getCourseByEnrolledId)
